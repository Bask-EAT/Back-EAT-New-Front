      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
        <div className="max-w-6xl w-full flex items-center">
          ...
          <div className="flex-1 text-center">
            <img src="/logo.png" alt="Bask:EAT 로고" className="object-contain mx-auto mb-6" />
            <h1 className="text-6xl font-extrabold text-gray-900 mb-4">Bask:EAT</h1>
            <p className="text-xl md:text-2xl text-gray-600">고민 없이 한 번에 담으세요!</p>
          </div>

          {/* 로그인 카드 - 오른쪽 */}
          <div className="flex-1 flex justify-center">
            <div className="bg-white rounded-2xl shadow-xl/20 p-10 border border-gray-100 w-full max-w-md">
